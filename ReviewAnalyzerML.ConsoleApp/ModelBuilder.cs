...
namespace ReviewAnalyzerML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\Захар\source\repos\ML\ReviewAnalyzer\reviews\reviews.csv";
        private static string MODEL_FILEPATH = @"C:\Users\Захар\AppData\Local\Temp\MLVSTools\ReviewAnalyzerML\ReviewAnalyzerML.Model\MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var dataProcessPipeline = mlContext.Transforms.Text.FeaturizeText("feature_tf", "feature")
                                      .Append(mlContext.Transforms.CopyColumns("Features", "feature_tf"))
                                      .Append(mlContext.Transforms.NormalizeMinMax("Features", "Features"))
                                      .AppendCacheCheckpoint(mlContext);
            // Set the training algorithm 
            var trainer = mlContext.BinaryClassification.Trainers.AveragedPerceptron(labelColumnName: "0", numberOfIterations: 10, featureColumnName: "Features");
